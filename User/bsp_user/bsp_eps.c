...
/*
	eps_data_Init(&eps_adc_data,&eps_state,&eps_bat);

	eps_data_handling(&eps_adc_data,&eps_state,&eps_bat);
*/
...
{
	//init eps_adc
	memset(eps_adc,0,sizeof(eps_hk_adc_t));
...
{
	//
	bat_data_processing(eps_adc,eps_bat);
	//
	output_data_processing(eps_adc,eps_state);
	//
	conv_data_processing(eps_adc,eps_state);
	//
	temp_data_processing(eps_adc,eps_state);
}
/**
*@
*@
